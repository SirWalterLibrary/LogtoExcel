...
def run_button(len_entry,wid_entry,hei_entry,window,import_entry,export_entry):
...
def main():
    ...
    # create a "Run" button 
    with_button = tk.Button(validate_frame, text="Run", width=40, command=lambda:run_button(len_entry,wid_entry,hei_entry,window,import_entry,export_entry))
