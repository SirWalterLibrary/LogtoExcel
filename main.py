...
def script(log_path,export_entry,length=0,width=0,height=0):
...
def run(len_entry,wid_entry,hei_entry,window,import_entry):
...
def main():
    ...
    # create a "Run" button 
    with_button = tk.Button(validate_frame, text="Run", width=40, command=run(len_entry,wid_entry,hei_entry,window,import_entry))
